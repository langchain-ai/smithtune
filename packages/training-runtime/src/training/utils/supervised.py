...
# smithtune: use the pinned helper without tinker-cookbook's conflicting dependency metadata.
from training._vendor.tinker_cookbook_0_4_3.supervised_common import datum_from_model_input_weights
