...
def diagnose() -> dict:
    packages = {}
    for name in ("smithtune", "fireworks-training-cookbook", "tinker-cookbook", "fireworks-ai", "baseten-loops", "jsonschema", "transformers", "torch", "deepagents", "langchain-openai", "pydantic-monty"):
        try:
