...
- Resume partial dataset imports with the original settings and saved `--run-dir`, `--output`, or `--triage-dir`. See [dataset recovery guidance](docs/datasets.md) for legacy receipts or conflicting remote content.
